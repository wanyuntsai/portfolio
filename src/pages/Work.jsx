...
function Projects() {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: t('A mental wellness app for the Canadian market, bridging the gap between daily journaling and accessible mental health resources.',
  '為加拿大市場設計的心理健康 App，填補日記記錄與心理諮詢資訊管道之間的市場缺口。'),
            tags: ["UX/UI", "Figma", "User Research"],
            link: "/work/MindLog",
            category: "UX/UI Design",
